...
After that, install `tensorflow` and `keras` in python using `keras` R package. You may also need to install Anaconda if you does not have it. For more information about installation of keras, please visit https://keras.rstudio.com/
```{r, eval=FALSE}
